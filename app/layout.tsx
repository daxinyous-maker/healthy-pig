...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "生息 · 个人健康管理";
  const description = "在一个安静、清晰的空间里，管理睡眠、饮食和运动。";
  return {
    metadataBase: new URL(origin),
    title,
    description,
    openGraph: { title, description, type: "website", images: [{ url: `${origin}/og.png`, width: 1200, height: 630, alt: "生息个人健康管理" }] },
